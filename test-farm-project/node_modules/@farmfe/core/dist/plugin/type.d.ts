...
import { Config, ModuleType, PluginLoadHookParam, PluginLoadHookResult, PluginResolveHookParam, PluginResolveHookResult, PluginTransformHookParam, PluginTransformHookResult } from '../types/binding.js';
...
export interface CompilationContext {
    resolve(param: PluginResolveHookParam, hookContext: {
...
type Callback<P, R> = (param: P, context?: CompilationContext, hookContext?: {
    caller?: string;
    meta: Record<string, unknown>;
...
export interface JsPlugin {
    ...
    buildStart?: {
        executor: Callback<Record<string, never>, void>;
    };
    ...
    load?: JsPluginHook<{
        resolvedPaths: string[];
    }, PluginLoadHookParam, PluginLoadHookResult>;
    transform?: JsPluginHook<{
        resolvedPaths?: string[];
        moduleTypes?: string[];
    }, PluginTransformHookParam, PluginTransformHookResult>;
    processModule?: JsPluginHook<NormalizeFilterParams, PluginProcessModuleParams, PluginProcessModuleResult>;
    buildEnd?: {
        executor: Callback<Record<string, never>, void>;
    };
    renderStart?: {
    ...
    renderResourcePot?: JsPluginHook<{
        ...
        moduleIds?: string[];
    }, PluginRenderResourcePotParams, PluginRenderResourcePotResult>;
    augmentResourceHash?: JsPluginHook<{
        resourcePotTypes?: ResourcePotType[];
        moduleIds?: string[];
    }, ResourcePotInfo, string>;
    finalizeResources?: {
...
export type { PluginResolveHookParam, PluginResolveHookResult, PluginLoadHookParam, PluginLoadHookResult, PluginTransformHookParam, PluginTransformHookResult } from '../types/binding.js';
