...
export type NormalizedServerConfig = Required<Omit<UserServerConfig, 'hmr'> & {
...
type AvailableUserConfigKeys = Exclude<keyof InternalConfig, 'configFilePath' | 'env' | 'coreLibPath' | 'root'>;
export interface UserConfig {
    ...
    /** vite plugins */
    vitePlugins?: (null | undefined | object | (() => {
        vitePlugin: any;
        filters: string[];
    }))[];
